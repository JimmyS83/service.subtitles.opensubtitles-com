...
from resources.lib.oss.model.request.abstract import OpenSubtitlesRequest
...
class OpenSubtitlesSubtitlesRequest(OpenSubtitlesRequest):
    def __init__(self, id_ = None, imdb_id = None, tmdb_id = None, type_=u"all", query="", languages=u"",
